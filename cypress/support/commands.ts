...
Cypress.Commands.add("clearInputs", (selectorToclick: string, selectorToclean: any[]) =>  {
...
Cypress.Commands.add("checkErrorText", (selectorBeenabled: string, selectorText: any[]) =>  {
